package org.apachechina.fsphoto.upload;
...
/**
 * 
 * 上传的测试类.需要commons-io 和 commons-fileUpload的支持. 自动生成到outDir目录.
 * 
 * @author 倪森 @Email nisen.cn@gmail.com 类创建时间: 2006-12-7 9:46:51
 * 
 */
	...
	private void processUploadedFile(FileItem item) throws Exception {
		...
		if (!item.isFormField()) {
			...
			if (writeToFile) {
				...
				if (!outDir.exists())
					FileUtils.forceMkdir(outDir); // 产生目录
