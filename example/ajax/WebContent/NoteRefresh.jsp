...
<%
	...
	if("down".equals(request.getParameter("operate")))		
	{
		note.down();
	}
	else if("up".equals(request.getParameter("operate")))
	{
		note.up();
	}
...
<body>
	...
	<a href="NoteRefresh.jsp?operate=up"> 顶</a></>:<span  id="up"> ${note.upNum}</span> <br />
	  <a href="NoteRefresh.jsp?operate=down">踩</a><span id="down"> ${note.downNum}</span>
