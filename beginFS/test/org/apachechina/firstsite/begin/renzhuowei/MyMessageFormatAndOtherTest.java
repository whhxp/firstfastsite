...
public class MyMessageFormatAndOtherTest extends TestCase{
	...
	{
		String execept=MyMessageFormat.format("我是{0},年龄{1},{0}", new Object[]{"天啊",24});
		String real=org.apachechina.firstsite.begin.jinlei.MyMessageFormat.format("我是{0},年龄{1},{0}", new Object[]{"天啊",24});
